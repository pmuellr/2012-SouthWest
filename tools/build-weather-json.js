...
for (var i=0; i<entries.length; i++) {
    ...
    contents = contents.replace(/<html.*?>/g,'')
    contents = contents.replace(/<\/html>/g,'')
    contents = contents.replace(/<head>/g,'')
    contents = contents.replace(/<\/head>/g,'')
    contents = contents.replace(/<body.*?>/g,'')
    contents = contents.replace(/<\/body>/g,'')
    contents = contents.replace(/<table.*?>/g,'')
    contents = contents.replace(/<\/table>/g,'')
    contents = contents.replace(/<tr.*?>/g,'')
    contents = contents.replace(/<\/tr>/g,'')
    contents = contents.replace(/<td.*?>/g,'')
    contents = contents.replace(/<\/td>/g,'')
